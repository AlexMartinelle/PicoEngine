// PicoEngineSamples.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	//The example...
	CogitareComputing::Pico::Engine engine("LD33", 640, 480, 60, vs, fs, CogitareComputing::Pico::SystemSpecificData());
